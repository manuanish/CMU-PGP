...
class DictExportVisitor:
    ...
    def default_visit(self, node):
        ...
        for field in node._fields:
            ...
            meth = getattr(
                self, "visit_field_" + node_type + "_" + field, self.default_visit_field
            )
        ...
        for attr in node._attributes:
            ...
            meth = getattr(
                self,
                "visit_attribute_" + node_type + "_" + attr,
    ...
    def visit_field_Num_n(self, val):
        if isinstance(val, int):
            return {self.ast_type_field: "int", "n": str(val)}
        elif isinstance(val, float):
            return {self.ast_type_field: "float", "n": str(val)}
